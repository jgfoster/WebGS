...
The sync and async tests measure performance. On an Apple M4 the sync server answers about 800 (trivial) AJAX requests per second and about 100 (small) file requests per second. 
